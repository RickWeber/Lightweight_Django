...
settings.configure(
    ...
    ####
    # NOTE:
    # The book includes the "TEMPLATE_DIRS" section, but the github code includes the "TEMPLATES" section.
    # Adding the TEMPLATES section resolved the "TemplateDoesNotExist at /" exception.
    ####
    TEMPLATES=(
        {
...
class ImageForm(forms.Form):
    ...
    def generate(self, image_format='PNG'):
        ...
        if content is None:
            ...
            content.seek(0)
            cache.set(key, content, 60 * 60) # store for one hour (60 minutes x 60 seconds)
        return content
